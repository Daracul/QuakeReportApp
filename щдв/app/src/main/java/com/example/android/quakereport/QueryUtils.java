...
/**
 * Created by amalakhov on 17.04.2018.
 */
...
public final class QueryUtils {
    ...
    public static ArrayList<Quake> fetchEarthquakeData(String requestUrl) {
        ...
        ArrayList<Quake> earthquake = extractFeatureFromJson(jsonResponse);
    ...
    private static ArrayList<Quake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONArray featuresJSON = rootJSON.getJSONArray("features");

            for (int i=0; i < featuresJSON.length(); i++){
                JSONObject feature = featuresJSON.getJSONObject(i);
                JSONObject properties = feature.getJSONObject("properties");
                double magnitude = properties.getDouble("mag");
                String place = properties.getString("place");
                long unixSecond = properties.getLong("time");

                String url = properties.getString("url");

                //create quake object and add it to array
                earthquakes.add(new Quake(magnitude,place,unixSecond, url));
